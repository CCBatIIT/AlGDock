...
integrateVV(PyObject *dummy, PyObject *args)
{
  ...
  for (i = first_step; i < last_step; i++) {
    ...
    printf("p_energy.energy= %.5lf; k_energy= %.5lf; n_energy= %.5lf; a_energy= %.5lf;\n temperature= %.5lf; pressure= %.5lf; volume= %.5lf\n",
      p_energy.energy, k_energy, n_energy, a_energy, temperature, pressure, volume);
