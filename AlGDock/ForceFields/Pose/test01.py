...
universe = InfiniteUniverse(Amber12SBForceField(parameter_file='/export/apps/amber/14/dat/leap/parm/gaff.dat', mod_files=['frcmod.ff12SB', mol_frcmod]))

FNs = {}
FNs['ligand_database'] = '1s3v'
molecule = Molecule(os.path.basename(FNs['ligand_database']))
