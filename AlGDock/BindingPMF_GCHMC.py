...
if 'ALGDOCKHOME' not in os.environ: # EU BEGIN
  print "ALGDOCKHOME enviroment variable not set"
  print "Exiting..."
  sys.exit(1)
else:
...
#        os.environ['OMP_NUM_THREADS']='1'
  ...
  def _mixed_sampler2(self, steps, steps_per_trial, T, delta_t, random_seed, normalize=False, adapt=False): # EU
    ...
    (mixed_confs0, mixed_potEs0, mixed_accs0, mixed_ntrials0, mixed_dts0) = \
      self.mixed_samplers[0].Call(ntrials*5, 5, T, 0.0030, random_seed%254, 1, 1)
