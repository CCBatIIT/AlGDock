...
self = AlGDock.BindingPMF_plots.BPMF_plots(\
  ...
  dir_grid='grids', \
  protocol='Adaptive', cool_therm_speed=0.1, dock_therm_speed=0.2,\
  sampler='NUTS', \
  MCMC_moves=1, \
  seeds_per_state=50, steps_per_seed=1000, darts_per_seed=5, \
  sweeps_per_cycle=100, attempts_per_sweep=25, \
